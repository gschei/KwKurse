		...
		<div id="list-person" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="newsletter" title="${message(code: 'person.newsletter.label', default: 'Newsletter')}" />
				...
				<g:each in="${personInstanceList}" status="i" var="personInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatBoolean boolean="${personInstance.newsletter}" /></td>
